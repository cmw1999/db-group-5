...
#7.1
/*Selects the total games played in and points scored by a team in order for the announcers to be able to talk about team achievements*/
...
#7.2
/*Gets the average salary of a position -> to help announcers to talk about pay around the league*/
